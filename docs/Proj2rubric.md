...
|Does your website and documentation provide a clear, high-level overview of your software?|3|https://github.com/spark1217/slash-group32/tree/main/docs|
|Does your website and documentation clearly describe the type of user who should use your software?|3|https://github.com/spark1217/slash-group32/tree/main/docs|
...
|Is the name of your project/software unique?|2|Slash is a somewhat unique name|
|Is your project/software name free from trademark violations?|3|No trademark violations|
|Is your software available as a package that can be deployed without building it?|3|https://github.com/spark1217/slash-group32/blob/main/requirements.txt |
|Is your software available for free?|3|The software is free to use.|
|Is your source code publicly available to download, either as a downloadable bundle or via access to a source code repository?|3|All source code is accessible. https://github.com/spark1217/slash-group32 |
|Is your software hosted in an established, third-party repository likeGitHub (https://github.com), BitBucket (https://bitbucket.org),LaunchPad (https://launchpad.net) orSourceForge (https://sourceforge.net)?|3|Hosted on github. https://github.com/spark1217/slash-group32 |
|Is your documentation clearly available on your website or within your software?|3|https://github.com/spark1217/slash-group32/tree/main/docs|
|Does your documentation include a "quick start" guide, that provides a short overview of how to use your software with some basic examples of use?|3|https://github.com/spark1217/slash-group32/tree/main/docs|
|If you provide more extensive documentation, does this provide clear, step-by-step instructions on how to deploy and use your software?|3|https://github.com/spark1217/slash-group32/tree/main/docs|
|Do you provide troubleshooting information that describes the symptoms and step-by-step solutions for problems and error messages?|3|https://github.com/spark1217/slash-group32/tree/main/docs|
|If your software can be used as a library, package or service by other software, do you provide comprehensive API documentation?|3|https://github.com/spark1217/slash-group32/tree/main/docs|
|Do you store your documentation under revision control with your source code?|3|https://github.com/spark1217/slash-group32/tree/main/docs|
|Do you publish your release history e.g. release data, version numbers, key features of each release etc. on your web site or in your documentation?|3|https://github.com/spark1217/slash-group32/tree/main/docs|
...
|Does your project have an e-mail address or forum that is solely for supporting users?|3|https://github.com/spark1217/slash-group32#readme|
|Are e-mails to your support e-mail address received by more than one person?|1|no only one person|
...
|Does your documentation adhere to appropriate accessibility conventions or standards?|3|https://github.com/spark1217/slash-group32/tree/main/docs|
...
|Are releases tagged in the repository?|3|https://github.com/spark1217/slash-group32/releases/tag/v2.0.0 |
...
|Do you have a framework to periodically (e.g. nightly) run your tests on the latest version of the source code?|3|https://github.com/spark1217/slash-group32/actions|
|Do you use continuous integration, automatically running tests whenever changes are made to your source code?|3|https://github.com/spark1217/slash-group32/actions|
|Are your test results publicly visible?|3|https://github.com/spark1217/slash-group32/actions|
...
|Do you list your important partners and collaborators on your website?|1|https://github.com/spark1217/slash-group32/graphs/contributors|
...
|Do you have a contributions policy?|3|https://github.com/spark1217/slash-group32/blob/main/CONTRIBUTING.md |
...
|Does your website and documentation clearly state the licence of your software?|3|https://github.com/spark1217/slash-group32/blob/main/LICENSE |
